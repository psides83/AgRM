export const faqCategories = [
  {
    id: 'aws',
    title: 'AWS',
    description: 'Optimize performance and reduce costs using scalable AWS cloud platforms.',
    avatar: {
  ...
  },
  {
    id: 'agrm',
    title: 'AgRM',
    description: 'Simplify backend operations with AgRM’s clean, modern admin interface.',
    avatar: {
    ...
    items: [
      {
        id: 1,
        question: 'What makes AgRM unique?',
        answer:
          'AgRM is designed for seamless integration with Material UI components, offering a collection of pre-styled elements that facilitate creating cohesive, visually appealing interfaces. This integration allows developers to streamline the design process, ensuring that components fit effortlessly into various layouts and use cases, saving time and enhancing visual consistency.',
      },
      {
        id: 2,
        question: 'Can I use third-party plugins?',
        answer:
          'Absolutely. AgRM is compatible with numerous third-party plugins, making it highly adaptable for diverse application needs. You can add analytics, SEO tools, or specialized UI components without complex setup, offering extensive flexibility to developers who want to tailor the app while maintaining performance and stability. <br/><br/>By supporting a range of integrations, AgRM empowers developers to expand functionality with ease, while ensuring a reliable and high-performance user experience. This versatility makes AgRM a valuable choice for both startups and enterprises that prioritize adaptability and customization in their applications.',
      },
      {
        id: 3,
        question: 'Is AgRM responsive?',
        answer:
          'AgRM is fully responsive, ensuring smooth functionality across all devices, from mobile to desktop. This adaptability eliminates the need for extensive adjustments, giving users a consistently great experience that aligns with modern design standards.',
      },
      {
        id: 4,
        question: 'What themes are available?',
        answer:
          'AgRM includes both light and dark themes, with options for extensive customization to meet unique brand identities. Users can modify colors, fonts, and overall styles to create an interface that reflects specific aesthetic and branding requirements. Seamless theme-switching enhances accessibility, allowing users to choose their preferred appearance effortlessly, promoting engagement and retention through a tailored user experience. <br/><br/> AgRM’s themes are built with inclusivity in mind, creating accessible and welcoming interfaces that adapt to user preferences. These options allow brands to reinforce their identity through visual consistency, contributing to a memorable, cohesive user journey.',
      },
      {
        id: 5,
        question: 'Can I use AgRM with Next.js?',
        answer:
          'Yes, AgRM is designed to integrate smoothly with Next.js, supporting both server-side rendering and static site generation. By using Next.js alongside AgRM, developers can create high-performance, SEO-friendly applications that load quickly and offer enhanced user experience. The combination brings together optimized rendering with cohesive styling, making it ideal for scalable applications across varied industries.',
      },
      {
        id: 6,
        question: 'Do you offer customer support for AgRM?',
        answer:
          'Yes, AgRM has a dedicated support team to assist at all stages, from installation to advanced customization. This enables developers to confidently integrate AgRM, knowing that help is available to resolve any issues they may encounter.',
      },
      {
        id: 7,
        question: 'Does AgRM support localization?',
        answer:
          'Yes, AgRM is fully equipped for localization, supporting i18n for multilingual applications, making it ideal for global audiences. The framework includes settings for easy language adaptation, allowing users to switch languages and catering to diverse regional needs. This enhances accessibility and enables developers to build inclusive applications that resonate with diverse audiences. AgRM’s focus on localization also reflects a commitment to global inclusivity, making it an effective choice for brands aiming to reach a worldwide user base.',
      },
      {
        id: 8,
        question: 'Is AgRM SEO-friendly?',
        answer:
          'Yes, AgRM is developed with SEO best practices in mind, ensuring optimized headers, metadata, and load times. This helps applications rank higher in search results, boosting web visibility. AgRM’s design, combined with features like server-side rendering through Next.js, makes it ideal for creating high-performance, discoverable applications, which is essential for businesses looking to improve their online presence in an increasingly competitive digital landscape.',
      },
      {
        id: 9,
        question: 'What customization options does AgRM provide?',
        answer:
          'AgRM offers a wide range of customization options, from color schemes and typography to layout configurations. Developers can easily adjust these elements to align with brand identity, creating a unique and cohesive design. AgRM’s flexibility empowers developers to keep their UI fresh and aligned with evolving design trends, catering to the brand’s unique vision and aesthetic requirements while maintaining a high-quality user experience.',
      },
      {
        id: 10,
        question: 'How secure is AgRM?',
        answer:
          'AgRM prioritizes security by supporting best coding practices, HTTPS, and other security protocols. It integrates well with secure libraries and frameworks, ensuring that user data remains protected. <br/><br/>AgRM’s emphasis on security makes it a dependable choice for applications requiring robust data protection measures. For developers focusing on user privacy and data integrity, AgRM’s security provisions make it a valuable asset in creating trustworthy applications. AgRM’s alignment with modern security standards means that developers can confidently build applications with built-in data protection, safeguarding user information from potential threats.',
      },
      {
        id: 11,
        question: 'Does AgRM support animation?',
        answer:
          'Yes, AgRM includes built-in support for animations, allowing developers to add visual enhancements that improve user engagement. AgRM’s animations are lightweight and follow modern design trends, ensuring that applications remain responsive and visually appealing without sacrificing performance. These features make AgRM an excellent option for developers seeking to integrate dynamic elements without compromising on speed or responsiveness, contributing to a lively and interactive user experience.',
      },
      {
        id: 12,
        question: 'Can I integrate AgRM with REST APIs?',
        answer:
          'AgRM is fully compatible with REST APIs, allowing developers to incorporate dynamic data seamlessly. This compatibility enables real-time data fetching and user-specific information display, making it suitable for creating data-driven applications. By supporting REST API integration, AgRM provides developers with the tools to build rich, interactive applications that cater to personalized user experiences and dynamic content delivery.',
      },
    ],
  },
  {
    id: 'pricing',
    title: 'Pricing',
    description: 'Choose a plan that fits your team, goals, and budget.',
    avatar: {
  ...
  },
  {
    id: 'campaign',
    title: 'Campaign',
    description: 'Plan smarter campaigns with data-driven tools and automation features.',
    avatar: {
  ...
  },
  {
    id: 'templates',
    title: 'Templates',
    description: 'Save time with pre-built templates for every common task.',
    avatar: {
  ...
  },
  {
    id: 'segments',
    title: 'Segments',
    description: 'Build custom segments that adapt to your users in real time.',
    avatar: {
  ...
  },
  {
    id: 'billing',
    title: 'Billing',
    description: 'Billing made easy—transparent, flexible, and always up to date.',
    avatar: {
  ...
  },
  {
    id: 'accounts',
    title: 'Accounts',
    description: 'Manage user accounts, access levels, and personal settings with ease.',
    avatar: {
  ...
  },
  {
    id: 'security',
    title: 'Security',
    description: 'Covering data protection, access controls, and compliance essentials.',
    avatar: {
    ...
    items: [
      {
        ...
        answer:
          'We implement strong encryption (both in transit and at rest), multi-layer firewalls, and continuous monitoring to safeguard your data against unauthorized access.',
      },
      {
        id: 2,
        question: 'Do you comply with GDPR and HIPAA?',
        answer:
          'Yes, our platform is fully compliant with GDPR and HIPAA regulations. We regularly undergo audits to ensure compliance with global data protection standards.',
      },
      {
        id: 3,
        question: 'Can I set role-based access controls?',
        answer:
          'Yes, administrators can assign different access levels to team members. Permissions can be customized to restrict sensitive data access only to authorized users.',
      },
      {
        id: 4,
        question: 'Do you perform regular security audits?',
        answer:
          'Yes, we perform internal and external audits regularly, as well as penetration testing to identify and resolve vulnerabilities proactively.',
      },
      {
        id: 5,
        question: 'Is multi-factor authentication available?',
        answer:
          'Absolutely. MFA can be enabled for all accounts to add an extra layer of security beyond just usernames and passwords.',
      },
    ],
  },
  {
    id: 'support',
    title: 'Support',
    description: 'For contacting help, tickets, or using the help center.',
    avatar: {
    ...
    items: [
      {
        ...
        answer:
          'You can reach support through email, live chat, or by submitting a ticket in your dashboard. Our team is available 24/7 to assist you.',
      },
      {
        id: 2,
        question: 'Do you offer priority support?',
        answer:
          'Yes, premium plans include priority support with faster response times and direct access to senior support agents.',
      },
      {
        id: 3,
        question: 'Where can I find tutorials or documentation?',
        answer:
          'All guides, FAQs, and tutorials are available in our Help Center. You can access it anytime from your dashboard.',
      },
      {
        id: 4,
        question: 'What is the typical response time?',
        answer:
          'Response times vary by plan. Standard support typically responds within 24 hours, while priority support users receive responses within 2–4 hours.',
      },
      {
        id: 5,
        question: 'Can I track my support tickets?',
        answer:
          'Yes, all submitted tickets can be tracked within your dashboard. You’ll see updates, responses, and estimated resolution times in real time.',
      },
    ],
  },
  {
    id: 'usersTeams',
    title: 'Users & Teams',
    description: 'Manage user roles, permissions, and team collaboration.',
    avatar: {
    ...
    items: [
      {
        ...
        answer:
          'To add a new user, go to the Users & Teams section in your dashboard, click “Add Member,” and assign them a role with the appropriate permissions.',
      },
      {
        id: 2,
        question: 'What roles are available?',
        answer:
          'Roles include Admin, Manager, and Member. Admins have full access, Managers have limited administrative controls, and Members have standard access.',
      },
      {
        id: 3,
        question: 'Can I assign custom permissions?',
        answer:
          'Yes, admins can configure custom permissions to restrict or grant access to specific features, ensuring flexibility for your organization’s needs.',
      },
      {
        id: 4,
        question: 'Is there a limit to the number of team members?',
        answer:
          'No, our platform supports unlimited team members. Pricing may vary based on the number of active users under your subscription plan.',
      },
      {
        id: 5,
        question: 'Can I remove or deactivate users?',
        answer:
          'Yes, users can be deactivated or permanently removed at any time through the Users & Teams dashboard. Deactivation retains historical data while restricting login access.',
      },
    ],
  },
  {
    ...
    description: 'For dashboards, KPIs, and performance metrics.',
    avatar: {
    ...
    items: [
      {
        ...
        answer:
          'Our analytics dashboard includes KPIs like active users, engagement rates, conversion funnels, and revenue metrics, updated in real time.',
      },
      {
        id: 2,
        question: 'Can I export reports?',
        answer:
          'Yes, reports can be exported in PDF, CSV, or Excel formats for offline use or integration with external tools.',
      },
      {
        id: 3,
        question: 'Do you support custom dashboards?',
        answer:
          'Yes, you can create custom dashboards by selecting widgets, KPIs, and data sources relevant to your business goals.',
      },
      {
        id: 4,
        question: 'Are real-time insights available?',
        answer:
          'Yes, real-time data updates allow you to monitor performance instantly, enabling faster decision-making for critical campaigns.',
      },
      {
        id: 5,
        question: 'Can reports be scheduled automatically?',
        answer:
          'Yes, you can schedule automated report deliveries on a daily, weekly, or monthly basis to your email or team workspace.',
      },
      {
        id: 6,
        question: 'Do you integrate with BI tools?',
        answer:
          'Yes, our analytics can integrate with tools like Tableau, Power BI, and Google Data Studio for advanced visualizations and analysis.',
      },
    ],
  },
];
