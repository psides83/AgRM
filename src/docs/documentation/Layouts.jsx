  ...
  return (
      ...
      pageHeaderProps={{
        ...
        descriptionEl: (
          <Typography sx={{ color: 'text.secondary' }}>
            AgRM offers a highly flexible layout system designed to cater to various application
    ...
    >
        ...
        >
          ...
          <ListItem>
            <ListItemText disableTypography>
              ...
              AgRM's Combo Layout allows for combining any of the Sidenav variants with any of the
      ...
      <DocSection title="Main Layout Configuration">
        <Typography sx={{ color: 'text.secondary' }}>
          AgRM's layout logic is managed inside the MainLayout component located at{' '}
        ...
        <Typography sx={{ mb: 2, color: 'text.secondary' }}>
          ...
          as the default layout for AgRM. If you need to use a specific layout—such as{' '}
...
`}
      ...
      <DocSection title="Sidanav-Only Layout">
        <Typography sx={{ color: 'text.secondary', mb: 5 }}>
          The <Code>SidenavLayout</Code> component configures AgRM to use only the default side
...
`}
      ...
      <DocSection title="Topnav-Only Layout">
        <Typography sx={{ color: 'text.secondary', mb: 5 }}>
          The <Code>TopnavLayout</Code> component configures AgRM to use only the default top
          navigation layout.
        </Typography>
...
`}
      ...
      <DocSection title="Combo Layout">
        <Typography sx={{ color: 'text.secondary', mb: 2 }}>
          The <Code>ComboLayout</Code> component configures AgRM to use both top and side
