  ...
  return (
      ...
      pageHeaderProps={{
        ...
        descriptionEl: (
          <Typography sx={{ color: 'text.secondary' }}>
            AgRM is configured to handle API requests efficiently using{' '}
    ...
    >
      <DocSection title="Axios Configuration">
        ...
        >
          AgRM uses a custom instance of Axios, <Code>axiosInstance</Code>, created with specific
  ...
  (error) => {
    return Promise.reject({
      ...
      <DocSection title="SWR">
        ...
        >
          For data fetching, caching and revalidation, AgRM uses{' '}
          <Link href="https://swr.vercel.app/" target="_blank">
            SWR
          </Link>{' '}
          to simplify the data-fetching logic in the project. AgRM also provides a custom{' '}
...
`}
        ...
        <Typography sx={{ color: 'text.secondary' }}>
          For every request, AgRM creates an SWR-based custom hook. All custom hooks for SWR-based
