  ...
  return (
      ...
      pageHeaderProps={{
        ...
        descriptionEl: (
          <Typography sx={{ color: 'text.secondary' }}>
            AgRM comes with a comprehensive set of configurations that allow you to customize the
    ...
    >
      <DocSection title="Config file">
        ...
        >
          <Typography>
            In AgRM, the configuration file is located at <Code>src/config.js</Code>, which
  ...
  fontSize: 16,
      ...
      <DocSection title="Managing Configuration">
        <Typography sx={{ color: 'text.secondary', mb: 5 }}>
          AgRM provides a powerful and flexible way to manage configuration settings throughout
