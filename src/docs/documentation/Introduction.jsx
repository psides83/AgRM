...
const Introduction = () => {
  return (
    <DocPageLayout pageHeaderProps={{ title: 'Introduction' }}>
      <DocSection title="About AgRM">
        <Typography sx={{ color: 'text.secondary' }}>
          AgRM is a React-based admin and landing template designed primarily for the MUI Store,
          built with Material UI. It features a modular architecture with ready-to-use modern UI
          components and a developer-friendly coding structure. AgRM uses the latest technologies,
      ...
      <DocSection title="TypeScript">
        <Typography sx={{ color: 'text.secondary' }}>
          AgRM is fully developed in <Code>TypeScript</Code>, ensuring robust type checking and
      ...
      <DocSection title="Authentication">
        <Typography sx={{ color: 'text.secondary' }}>
          AgRM supports multiple authentication methods, including <Code>JWT</Code>,{' '}
          <Code>Supabase</Code>, <Code>Auth0</Code>, <Code>NextAuth</Code> (for NextJs) and{' '}
      ...
      <DocSection title="Code Quality and Formatting">
        <Typography sx={{ color: 'text.secondary' }}>
          AgRM employs <Code>ESLint</Code> and <Code>Prettier</Code> to enforce code quality and
      ...
      <DocSection title="NextJs">
        <Typography sx={{ color: 'text.secondary' }}>
          ...
          options, making AgRM suitable for production-grade web applications.
        </Typography>
      </DocSection>
    </DocPageLayout>
  );
