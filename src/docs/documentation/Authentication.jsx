  ...
  return (
      ...
      pageHeaderProps={{
        ...
        descriptionEl: (
          <Typography sx={{ color: 'text.secondary' }}>
            AgRM offers multiple authentication methods. These options are customizable to meet
    ...
    >
      <DocSection title="How It Works">
        ...
        >
          AgRM's authentication system is designed to be flexible, allowing developers to choose
        ...
        <DocList sx={{ mb: 2 }}>
          ...
          <ListItem>
            <ListItemText disableTypography>
              ...
              <Code>src/providers/auth-provider/AuthSupabaseProvider.tsx</Code>
            </ListItemText>
          </ListItem>
        </DocList>
        ...
        <Typography sx={{ color: 'text.secondary' }}>
          The <Code>AuthProvider</Code> component in AgRM acts as the root provider, where all the
...
export default AuthProvider;`}
        ...
        <Typography sx={{ color: 'text.secondary' }}>
          ...
          folder. Each method (e.g., JWT, Supabase, Auth0) has its own directory containing relevant
          ...
          >
            ...
            >
              <ListItem>
                ...
                <Typography sx={{ mb: 2 }}>
                  By default, AgRM includes dummy endpoints and uses SWR for making requests. You
...
const AuthMethodContext = Auth0Context;`}
          ...
          <DocNestedSection
            ...
            title="Supabase"
            titleEl={
              <AnchorLinkContainer hashHref="supabase" anchorSize="small">
                <DocSubtitle>Supabase Authentication</DocSubtitle>
              </AnchorLinkContainer>
            }
          >
            <DocList
...
VITE_FIREBASE_APP_ID=`}
              ...
              <ListItem>
                <Typography>
                  Uncomment the import statement for <Code>AuthSupabaseProvider</Code> and{' '}
                  <Code>AuthSupabaseContext</Code> and set the
                  <Code>AuthMethodProvider</Code> and <Code>AuthMethodContext</Code> variables:
                </Typography>
                <CodeBlock
                  sx={{ mb: 0 }}
...
const AuthMethodContext = AuthSupabaseContext;`}
            ...
            <DocSubtitle sx={{ mb: 2 }}>Remove Supabase Method</DocSubtitle>
            <Typography sx={{ color: 'text.secondary' }}>
              If you do not need the Supabase authentication method, follow these steps to remove
              it:
            </Typography>
            <DocList
              sx={{
            ...
            >
              <ListItem>
                Delete the <Code>src/providers/auth-provider/AuthSupabaseProvider.tsx</Code> file.
              </ListItem>
              <ListItem>
                Comment out or remove the import statement for <Code>AuthSupabaseProvider</Code> and{' '}
                <Code>AuthSupabaseContext</Code>
                <CodeBlock
                  sx={{ mb: 0 }}
                  code={`// import AuthSupabaseProvider, { AuthSupabaseContext } from './auth-provider/AuthSupabaseProvider';`}
                />
              </ListItem>
              <ListItem>
                Delete the Supabase authentication-related UI pages located in{' '}
                <Code>src/pages/authentication/default/supabase</Code> folder and any associate
          ...
          <DocNestedSection component={ListItem} id="social-platform" title="Social Platform">
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2 }}>
              In AgRM, the social authentication method is based on <Code>Supabase</Code>. By
            ...
            >
              <ListItem>
                <Typography>
                  To configure Supabase authentication for social platforms, you'll must need to set
...
VITE_AZURE_AD_TENANT_ID=`}
              ...
              <ListItem>
                ...
                >
                  To check <Code>Supabase</Code> authenticated user a component named{' '}
    ...
    <AuthMethodProvider>
      <SocialAuthProvider>
        {children}
                ...
                >
                  This component is also used when you choose the <Code>supabase</Code>{' '}
                  authentication method. Therefore, do not remove this file and its integration if
                  you're using either <Code>Supabase</Code> authentication or{' '}
  ...
  /* ---------------------------------Supabase----------------------------------------- */
  // login: paths.defaultSupabaseLogin,
  // signup: paths.defaultSupabaseSignup,
  // forgotPassword: paths.defaultSupabaseForgotPassword,
  /* ---------------------------------Auth0----------------------------------------- */
  // login: paths.defaultAuth0Login,
        ...
        >
          In this example, JWT is set as the default provider, while Supabase and Auth0 are
      ...
      <DocSection title="Guards">
        ...
        >
          AgRM uses route guards to control access to certain routes based on the user's
  ...
  children: [
    ...
      ...
      <DocSection title="NextAuth Authentication (Next.js Only)">
        ...
        >
          This method is only available in the Next.js-based version of AgRM. It leverages
...
`}
        ...
        <DocList sx={{ color: 'text.secondary', mb: 5 }}>
          <ListItem>
            <ListItemText disableTypography>
              Includes CredentialsProvider, Auth0, Google, AzureAD, and Supabase providers.
            </ListItemText>
          </ListItem>
          <ListItem>
        ...
        >
          AgRM auto-attaches the <Code>authToken</Code> from session:
        </Typography>
        <CodeBlock
          sx={{ mb: 5 }}
