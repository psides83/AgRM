  ...
  return (
    <DocPageLayout
      pageHeaderProps={{
        ...
        descriptionEl: (
          ...
          >
            <strong>AgRM</strong> uses <strong>Yet Another React Lightbox</strong> for lightbox.{' '}
    ...
    >
      <DocSection title="How to use">
        <Typography>
          The <Code>useLightbox</Code> custom hook and <Code>Lightbox</Code> componet in AgRM
...
import useLightbox from 'hooks/useLightbox`}
      ...
      <DocSection
        ...
        descriptionEl={
          ...
          >
            In AgRM's <Code>Lightbox</Code> component, you can use <Code>extension</Code> prop to
