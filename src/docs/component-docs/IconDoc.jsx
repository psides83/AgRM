      ...
      pageHeaderProps={{
        ...
        descriptionEl: (
          <Typography variant="body1">
            Throughout the AgRM project, <Code>Iconify</Code> is used for icons, integrated via
            the{' '}
      ...
      <DocSection
        ...
        descriptionEl={
          <>
            ...
            >
              In AgRM, users can leverage Iconify's vast collection of icons from{' '}
            ...
            >
              ...
              AgRM, most of the icons in the project are sourced from the{' '}
